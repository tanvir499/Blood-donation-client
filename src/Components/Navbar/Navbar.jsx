...
import { 
  ...
  Home,
  Search,
  DollarSign, // Replaced Donate with DollarSign
  Shield,
  LogOut,
  User as UserIcon,
  Bell,
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { to: "/donation-Request", icon: <Droplets className="w-4 h-4" />, label: "Donation Requests" },
    { to: "/search", icon: <Search className="w-4 h-4" />, label: "Search" },
    { to: "/donate", icon: <DollarSign className="w-4 h-4" />, label: "Funding" }, // Fixed: DollarSign instead of Donate
  ];
  ...
  return (
    ...
    >
      ...
      {/* Floating Notification Badge (Animated) */}
      <motion.div
        animate={{ 
          y: [0, -5, 0],
          opacity: [0.8, 1, 0.8]
