...
const DonorDashboard = () => {
  ...
  const handleDeleteRequest = () => {
    ...
    axiosSecure.delete(`/request/${deleteModal.requestId}`)
      .then(() => {
          ...
          {recentRequests.length > 0 ? (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-800">Recent Donation Requests</h2>
                    <p className="text-gray-600">Your last 3 donation requests</p>
                  </div>
                </div>
                            ...
                            <td className="p-6">
                              <div className="flex items-center gap-2">
                                ...
                                <motion.button
                                  whileHover={{ scale: 1.1 }}
                                  whileTap={{ scale: 0.9 }}
                                  onClick={() => setDeleteModal({ open: true, requestId: request._id })}
            ...
            >
              ...
              <p className="text-gray-600 max-w-md mx-auto mb-8">
                You haven't created any donation requests yet. Create your first request to find blood donors.
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              <div className="bg-gradient-to-r from-red-500 to-pink-500 p-6 text-white">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">Are you sure you want to delete this request?</p>
                  </div>
                </div>
              </div>
