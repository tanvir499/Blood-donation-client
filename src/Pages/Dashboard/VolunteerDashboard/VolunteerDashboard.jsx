...
const Volunteer = () => {
    ...
    const handleAddvolunteer = async(e) => {
        ...
        try {
            ...
            if (file) {
                const res = await axios.post(`https://api.imgbb.com/1/upload?key=4ef5a5f7c97e1a04cc960bb3d1e91b93`, 
                    { image: file }, 
                    {
                        headers: {
            ...
            toast.success("Welcome to our volunteer team!", {
                position: "top-right",
                autoClose: 4000,
                theme: "colored",
            })
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                Become a volunteer and help save lives by connecting donors with those in need
                            </p>
                        </motion.div>
                                ...
                                <div className="space-y-8">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        onBlur={() => setTimeout(() => setShowBloodDropdown(false), 200)}
                                            ...
                                            <div className="space-y-2 md:col-span-2">
                                                ...
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        onBlur={() => setTimeout(() => setShowUpazilaDropdown(false), 200)}
                                                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none appearance-none bg-white cursor-pointer"
                                                        required
                                                    >
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-bold text-blue-800 mb-2">Volunteer Responsibilities</h4>
