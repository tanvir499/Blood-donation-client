...
import {Hospital,Droplets,Calendar,Clock, MapPin,Eye,ChevronLeft,ChevronRight,FileText,User,AlertCircle,Search,RefreshCw,TrendingUp,Activity
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br ">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 opacity-10 blur-3xl"
        />
      </div>
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                            className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center border-2 border-blue-200"
                          >
                      ...
                      <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-100">
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-semibold rounded-lg hover:shadow-md transition-all duration-300 flex items-center gap-2"
                        >
                    ...
                    <AnimatePresence>
                      {filteredRequests.map((request, index) => (
                        <motion.tr
                          ...
                          className="border-b border-gray-100 hover:bg-blue-50/50 transition-colors duration-300"
                        >
                          <td className="p-6">
                          ...
                          <td className="p-6">
                            <motion.button
                              whileHover={{ scale: 1.05 }}
                              whileTap={{ scale: 0.95 }}
                              className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold rounded-lg hover:shadow-md transition-all duration-300 flex items-center gap-2"
                            >
                              <Eye className="w-4 h-4" />
                              View
                            </motion.button>
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <input
                ...
                className="w-16 px-2 py-1 border border-gray-300 rounded text-center outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          </motion.div>
        )}
